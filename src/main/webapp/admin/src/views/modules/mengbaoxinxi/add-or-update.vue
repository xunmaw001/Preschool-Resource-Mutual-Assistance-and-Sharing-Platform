<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="萌宝姓名" prop="mengbaoxingming">
          <el-input v-model="ruleForm.mengbaoxingming" 
              placeholder="萌宝姓名" clearable  :readonly="ro.mengbaoxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="萌宝姓名" prop="mengbaoxingming">
              <el-input v-model="ruleForm.mengbaoxingming" 
                placeholder="萌宝姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生活习惯" prop="shenghuoxiguan">
          <el-input v-model="ruleForm.shenghuoxiguan" 
              placeholder="生活习惯" clearable  :readonly="ro.shenghuoxiguan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生活习惯" prop="shenghuoxiguan">
              <el-input v-model="ruleForm.shenghuoxiguan" 
                placeholder="生活习惯" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兴趣爱好" prop="xingquaihao">
          <el-input v-model="ruleForm.xingquaihao" 
              placeholder="兴趣爱好" clearable  :readonly="ro.xingquaihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="兴趣爱好" prop="xingquaihao">
              <el-input v-model="ruleForm.xingquaihao" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.mengbaotupian" label="萌宝图片" prop="mengbaotupian">
          <file-upload
          tip="点击上传萌宝图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.mengbaotupian?ruleForm.mengbaotupian:''"
          @change="mengbaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.mengbaotupian" label="萌宝图片" prop="mengbaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.mengbaotupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="萌宝简介" prop="mengbaojianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.mengbaojianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.mengbaojianjie" label="萌宝简介" prop="mengbaojianjie">
                    <span v-html="ruleForm.mengbaojianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	mengbaoxingming : false,
	xingbie : false,
	chushengriqi : false,
	tizhong : false,
	shenghuoxiguan : false,
	xingquaihao : false,
	mengbaojianjie : false,
	mengbaotupian : false,
	zhanghao : false,
	xingming : false,
	thumbsupnum : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='mengbaoxingming'){
            this.ruleForm.mengbaoxingming = obj[o];
	    this.ro.mengbaoxingming = true;
            continue;
          }
          if(o=='xingbie'){
	    ...
	    this.ro.xingquaihao = true;
          ...
          if(o=='mengbaojianjie'){
            this.ruleForm.mengbaojianjie = obj[o];
	    this.ro.mengbaojianjie = true;
            continue;
          }
          if(o=='mengbaotupian'){
            this.ruleForm.mengbaotupian = obj[o];
	    this.ro.mengbaotupian = true;
            continue;
          }
          if(o=='zhanghao'){
	...
	this.ruleForm.mengbaojianjie = this.ruleForm.mengbaojianjie.replace(reg,'../../../ssmkoam8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `mengbaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mengbaoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    mengbaotupianUploadChange(fileUrls) {
	this.ruleForm.mengbaotupian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
