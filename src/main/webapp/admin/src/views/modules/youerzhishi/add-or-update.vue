<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="相关文件" prop="xiangguanwenjian">
          <file-upload
          tip="点击上传相关文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.xiangguanwenjian?ruleForm.xiangguanwenjian:''"
          @change="xiangguanwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.xiangguanwenjian" label="相关文件" prop="xiangguanwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.xiangguanwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询师账号" prop="zixunshizhanghao">
          <el-input v-model="ruleForm.zixunshizhanghao" 
              placeholder="咨询师账号" clearable  :readonly="ro.zixunshizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询师账号" prop="zixunshizhanghao">
              <el-input v-model="ruleForm.zixunshizhanghao" 
                placeholder="咨询师账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询师姓名" prop="zixunshixingming">
          <el-input v-model="ruleForm.zixunshixingming" 
              placeholder="咨询师姓名" clearable  :readonly="ro.zixunshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询师姓名" prop="zixunshixingming">
              <el-input v-model="ruleForm.zixunshixingming" 
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhishijianjie = true;
          ...
          if(o=='xiangguanwenjian'){
            this.ruleForm.xiangguanwenjian = obj[o];
	    this.ro.xiangguanwenjian = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zixunshizhanghao!=''&&json.zixunshizhanghao){
              		this.ruleForm.zixunshizhanghao = json.zixunshizhanghao
	    		this.ro.zixunshizhanghao = true;
		}
		if(json.zixunshixingming!=''&&json.zixunshixingming){
	...
	this.ruleForm.zhishijianjie = this.ruleForm.zhishijianjie.replace(reg,'../../../ssmkoam8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `youerzhishi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youerzhishiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    xiangguanwenjianUploadChange(fileUrls) {
	this.ruleForm.xiangguanwenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
