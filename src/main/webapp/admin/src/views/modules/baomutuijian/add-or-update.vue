<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保姆姓名" prop="baomuxingming">
          <el-input v-model="ruleForm.baomuxingming" 
              placeholder="保姆姓名" clearable  :readonly="ro.baomuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保姆姓名" prop="baomuxingming">
              <el-input v-model="ruleForm.baomuxingming" 
                placeholder="保姆姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作经验" prop="gongzuojingyan">
          <el-input v-model="ruleForm.gongzuojingyan" 
              placeholder="工作经验" clearable  :readonly="ro.gongzuojingyan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作经验" prop="gongzuojingyan">
              <el-input v-model="ruleForm.gongzuojingyan" 
                placeholder="工作经验" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="保姆简介" prop="baomujianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.baomujianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baomujianjie" label="保姆简介" prop="baomujianjie">
                    <span v-html="ruleForm.baomujianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='baomuxingming'){
            this.ruleForm.baomuxingming = obj[o];
	    this.ro.baomuxingming = true;
            continue;
          }
          if(o=='nianling'){
	    ...
	    this.ro.pingjianeirong = true;
          ...
          if(o=='baomujianjie'){
            this.ruleForm.baomujianjie = obj[o];
	    this.ro.baomujianjie = true;
            continue;
          }
          if(o=='zhaopian'){
	...
	this.ruleForm.baomujianjie = this.ruleForm.baomujianjie.replace(reg,'../../../ssmkoam8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `baomutuijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baomutuijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
