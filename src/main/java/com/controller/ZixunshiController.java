...
public class ZixunshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZixunshiEntity user = zixunshiService.selectOne(new EntityWrapper<ZixunshiEntity>().eq("zixunshizhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"zixunshi",  "咨询师" );
